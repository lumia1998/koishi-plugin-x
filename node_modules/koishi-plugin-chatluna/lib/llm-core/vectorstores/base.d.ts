...
export declare abstract class ChatLunaSaveableVectorStore<T extends VectorStore = VectorStore> extends VectorStore {
    private _isActive;
    protected _store?: T;
...
export interface ChatLunaSaveableVectorStoreInput<T extends VectorStore = VectorStore> {
