...
import { AgentAction, AgentFinish, AgentStep, ScratchpadEntry } from '../types';
import type { ChatLunaChatModel } from '../../platform/model';
import { BaseChatPromptTemplate } from '@langchain/core/prompts';
export declare function _formatIntermediateSteps(intermediateSteps: ScratchpadEntry[]): BaseMessage[];
/**
