 ...
 * ```
 */
export declare function createReactAgent({ llm, tools, prompt, instructions }: CreateReactAgentParams): RunnableSequence<{
    steps: AgentStep[];
    scratchpadEntries?: ScratchpadEntry[];
}, import("@langchain/core/agents").AgentAction[] | {
    returnValues: {
        message: BaseMessage;
    };
    log: string;
 ...
 */
export declare function formatLogToString(intermediateSteps: ScratchpadEntry[], observationPrefix?: string, llmPrefix?: string): string;
