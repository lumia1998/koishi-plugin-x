...
export declare function parseRawModelName(modelName: string): [string | undefined, string | undefined];
 ...
 */
export declare function countMessagesTokens(messages: BaseMessage[], tokenCounter: (text: string) => Promise<number>, presetTokens?: number): Promise<number>;
export {};
