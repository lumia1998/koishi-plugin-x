...
import {
  BaseMemory as BaseMemory2,
  getInputValue as getInputValue2
} from "@langchain/core/memory";
var VectorStoreRetrieverMemory = class extends BaseMemory2 {
  static {
  ...
  async loadMemoryVariables(values) {
    const query = getInputValue2(values, this.inputKey);
