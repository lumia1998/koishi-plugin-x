...
export declare function callChatLunaChain(chain: ChatLunaLLMChain, values: ChainValues & ChatLunaLLMChain['llm']['ParsedCallOptions'], events: ChatEvents, callbacks?: Callbacks): Promise<ChainValues>;
