...
import type { EmbeddingsResult, RerankerUsageResult } from 'koishi-plugin-chatluna/llm-core/platform/usage';
export type { EmbeddingsResult, RerankerUsageResult };
export type { ChatLunaInvocationMetrics } from './metrics';
export { MIN_LATENCY_MS, attachInvocationMetrics, createModelUsageTiming, readInvocationMetrics } from './metrics';
...
export declare abstract class ModelRequester<T extends ClientConfig = ClientConfig, R extends ChatLunaPlugin.Config = ChatLunaPlugin.Config> implements BaseRequester {
    ...
    constructor(ctx: Context, _configPool: ClientConfigPool<T>, _pluginConfig: R, _plugin: ChatLunaPlugin<T, R>);
