...
export declare class ChatLunaChatModel extends BaseChatModel<ChatLunaModelCallOptions> {
    ...
    _streamResponseChunks(messages: BaseMessage[], options: this['ParsedCallOptions'], runManager?: CallbackManagerForLLMRun, reportUsage?: boolean): AsyncGenerator<ChatGenerationChunk>;
    private _createTokenUsageTracker;
    private _handleStreamChunk;
    private _hasToolCallChunk;
    private _hasResponse;
    private _updateTokenUsageFromChunk;
    private _finalizeStream;
    private _reportStreamUsage;
    private _closeStream;
    private _shouldRethrowStreamError;
    private _isNonRetryableError;
    ...
    get fileHandlingConfig(): FileHandlingConfig;
    _modelType(): string;
    /** @ignore */
