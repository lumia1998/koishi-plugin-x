...
var ChatLunaErrorCode = /* @__PURE__ */ ((ChatLunaErrorCode2) => {
  ...
  ChatLunaErrorCode2[ChatLunaErrorCode2["RERANKER_INIT_ERROR"] = 316] = "RERANKER_INIT_ERROR";
  ...
  ChatLunaErrorCode2[ChatLunaErrorCode2["CONVERSATION_TARGET_AMBIGUOUS"] = 410] = "CONVERSATION_TARGET_AMBIGUOUS";
  ChatLunaErrorCode2[ChatLunaErrorCode2["CONVERSATION_TARGET_OUTSIDE_ROUTE"] = 411] = "CONVERSATION_TARGET_OUTSIDE_ROUTE";
  ChatLunaErrorCode2[ChatLunaErrorCode2["CONVERSATION_NOT_FOUND"] = 412] = "CONVERSATION_NOT_FOUND";
  ChatLunaErrorCode2[ChatLunaErrorCode2["CONVERSATION_ADMIN_REQUIRED"] = 413] = "CONVERSATION_ADMIN_REQUIRED";
  ChatLunaErrorCode2[ChatLunaErrorCode2["CONVERSATION_LOCKED"] = 414] = "CONVERSATION_LOCKED";
  ChatLunaErrorCode2[ChatLunaErrorCode2["CONVERSATION_DISABLED"] = 415] = "CONVERSATION_DISABLED";
  ChatLunaErrorCode2[ChatLunaErrorCode2["CONVERSATION_FIXED"] = 416] = "CONVERSATION_FIXED";
  ChatLunaErrorCode2[ChatLunaErrorCode2["CONVERSATION_INVALID_CHAT_MODE"] = 417] = "CONVERSATION_INVALID_CHAT_MODE";
  ChatLunaErrorCode2[ChatLunaErrorCode2["CONVERSATION_ARCHIVE_NOT_FOUND"] = 418] = "CONVERSATION_ARCHIVE_NOT_FOUND";
  ChatLunaErrorCode2[ChatLunaErrorCode2["CONVERSATION_ARCHIVE_MISMATCH"] = 419] = "CONVERSATION_ARCHIVE_MISMATCH";
  ChatLunaErrorCode2[ChatLunaErrorCode2["CONVERSATION_RESTORE_FAILED"] = 420] = "CONVERSATION_RESTORE_FAILED";
  ChatLunaErrorCode2[ChatLunaErrorCode2["CONVERSATION_PLATFORM_NOT_AVAILABLE"] = 421] = "CONVERSATION_PLATFORM_NOT_AVAILABLE";
  ChatLunaErrorCode2[ChatLunaErrorCode2["CONVERSATION_INVALID_MODEL"] = 422] = "CONVERSATION_INVALID_MODEL";
