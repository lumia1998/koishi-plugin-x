...
import { isMessageContentImageUrl, isMessageContentText } from 'koishi-plugin-chatluna/utils/langchain';
...
export { isMessageContentImageUrl, isMessageContentText, transformMessageContentToElements };
export declare function getMimeTypeFromSource(sourceUrl?: string, fileName?: string): string | null;
...
export declare function sanitizeToolLogString(input: string): string;
export declare function sanitizeToolLogValue(value: unknown, visited?: Set<object>): unknown;
...
export declare const selectFromList: (args: string, isPick: boolean, seed?: string) => string;
...
export declare function getSystemPromptVariables(session: Session, config: Config, conversation: Pick<ConversationRecord, 'preset' | 'id' | 'updatedAt' | 'lastChatAt'>): {
    name: string;
    date: string;
    bot_id: string;
    is_group: boolean;
...
export declare function formatUserPromptString(config: Config, presetTemplate: PresetTemplate, session: Session, prompt: string, conversation: Pick<ConversationRecord, 'preset' | 'id' | 'updatedAt' | 'lastChatAt'>): Promise<import("@chatluna/shared-prompt-renderer").RenderResult>;
