...
__export(string_exports, {
  ...
  getMimeTypeFromSource: () => getMimeTypeFromSource,
  ...
  isMessageContentImageUrl: () => import_langchain.isMessageContentImageUrl,
  isMessageContentText: () => import_langchain.isMessageContentText,
  rollDice: () => rollDice,
  sanitizeToolLogString: () => sanitizeToolLogString,
  sanitizeToolLogValue: () => sanitizeToolLogValue,
  selectFromList: () => selectFromList,
  transformMessageContentToElements: () => import_koishi2.transformMessageContentToElements
});
...
var selectFromList = /* @__PURE__ */ __name((args, isPick, seed = "") => {
  ...
  if (isPick) {
    const hash = import_node_crypto.default.createHash("sha1").update(`${seed}:${args}`).digest();
