 ...
 * @param ctx - Koishi context object
 */
export declare function rerankerSchema(ctx: Context): void;
/**
...
export declare function listModelNames(service: PlatformService, type?: ModelType, includeNone?: boolean): import("@vue/reactivity").ComputedRef<string[]>;
