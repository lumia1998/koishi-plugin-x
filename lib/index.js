...
function generateTweetHTML(authorName, screenName, avatarUrl, tweetText, mediaPreviews) {
...
async function apply(ctx, config) {
    ...
    async function renderApiTweetCard(tpTweet, tweetWord, altOriginalText) {
        ...
        try {
            ...
            const html = generateTweetHTML(tpTweet.authorName, tpTweet.screenName, avatarDataUrl, tweetWord, mediaPreviews);
            if (config.outputLogs)
